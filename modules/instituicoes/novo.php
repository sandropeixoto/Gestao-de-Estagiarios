...
<head>
    ...
    <title>Nova Instituição - EstagiárioPlus</title>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
            ...
            <form action="save_institution.php" method="POST" class="p-8 space-y-8">
                ...
                <div class="pt-6 border-t border-gray-100 flex justify-end space-x-4">
                    <a href="instituicoes.php" class="px-6 py-2.5 rounded-lg text-gray-600 hover:bg-gray-100 transition-all font-medium">Cancelar</a>
