...
<div class="mb-8 flex justify-between items-center">
    ...
    <a href="<?= $baseUrl ?>modules/estudantes/novo.php" class="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-xl shadow-lg transition-all flex items-center font-semibold">
